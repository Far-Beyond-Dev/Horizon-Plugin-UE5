...
static UEnum* ESIOJ_JsonType_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_ESIOJ_JsonType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SIOJEditorPlugin_ESIOJ_JsonType, (UObject*)Z_Construct_UPackage__Script_SIOJEditorPlugin(), TEXT("ESIOJ_JsonType"));
	}
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SIOJEditorPlugin_ESIOJ_JsonType_Statics::EnumParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_SIOJEditorPlugin_ESIOJ_JsonType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_SIOJEditorPlugin_ESIOJ_JsonType_Statics::Enum_MetaDataParams)
};
...
// End Enum ESIOJ_JsonType

// Begin ScriptStruct FSIOJ_NamedType
...
class UScriptStruct* FSIOJ_NamedType::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SIOJ_NamedType.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSIOJ_NamedType, (UObject*)Z_Construct_UPackage__Script_SIOJEditorPlugin(), TEXT("SIOJ_NamedType"));
	}
...
const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FSIOJ_NamedType_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSIOJ_NamedType, Name), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Name_MetaData), NewProp_Name_MetaData) };
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSIOJ_NamedType_Statics::PropPointers) < 2048);
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSIOJ_NamedType_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_SIOJEditorPlugin,
	nullptr,
	&NewStructOps,
	"SIOJ_NamedType",
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSIOJ_NamedType_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSIOJ_NamedType_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FSIOJ_NamedType()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_SIOJ_NamedType.InnerSingleton, Z_Construct_UScriptStruct_FSIOJ_NamedType_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_SIOJ_NamedType.InnerSingleton;
}
// End ScriptStruct FSIOJ_NamedType

// Begin Class USIOJ_BreakJson
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USIOJ_BreakJson_Statics::NewProp_Outputs_Inner = { "Outputs", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FSIOJ_NamedType, METADATA_PARAMS(0, nullptr) }; // 3532283239
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USIOJ_BreakJson_Statics::NewProp_Outputs = { "Outputs", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USIOJ_BreakJson, Outputs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Outputs_MetaData), NewProp_Outputs_MetaData) }; // 3532283239
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USIOJ_BreakJson_Statics::PropPointers) < 2048);
UObject* (*const Z_Construct_UClass_USIOJ_BreakJson_Statics::DependentSingletons[])() = {
	(UObject* (*)())Z_Construct_UClass_UK2Node,
	(UObject* (*)())Z_Construct_UPackage__Script_SIOJEditorPlugin,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USIOJ_BreakJson_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_USIOJ_BreakJson_Statics::ClassParams = {
	...
	0,
	0x001000A0u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USIOJ_BreakJson_Statics::Class_MetaDataParams), Z_Construct_UClass_USIOJ_BreakJson_Statics::Class_MetaDataParams)
};
...
// End Class USIOJ_BreakJson

// Begin Registration
struct Z_CompiledInDeferFile_FID_Github_Stars_Beyond_Game_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESIOJ_JsonType_StaticEnum, TEXT("ESIOJ_JsonType"), &Z_Registration_Info_UEnum_ESIOJ_JsonType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4236622062U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FSIOJ_NamedType::StaticStruct, Z_Construct_UScriptStruct_FSIOJ_NamedType_Statics::NewStructOps, TEXT("SIOJ_NamedType"), &Z_Registration_Info_UScriptStruct_SIOJ_NamedType, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSIOJ_NamedType), 3532283239U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_USIOJ_BreakJson, USIOJ_BreakJson::StaticClass, TEXT("USIOJ_BreakJson"), &Z_Registration_Info_UClass_USIOJ_BreakJson, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USIOJ_BreakJson), 2972861592U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Github_Stars_Beyond_Game_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_548781280(TEXT("/Script/SIOJEditorPlugin"),
	Z_CompiledInDeferFile_FID_Github_Stars_Beyond_Game_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Github_Stars_Beyond_Game_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Github_Stars_Beyond_Game_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Github_Stars_Beyond_Game_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Github_Stars_Beyond_Game_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Github_Stars_Beyond_Game_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics::EnumInfo));
// End Registration
