...
// Begin Enum ESIOConnectionCloseReason
...
static UEnum* ESIOConnectionCloseReason_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_ESIOConnectionCloseReason.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SocketIOClient_ESIOConnectionCloseReason, (UObject*)Z_Construct_UPackage__Script_SocketIOClient(), TEXT("ESIOConnectionCloseReason"));
	}
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SocketIOClient_ESIOConnectionCloseReason_Statics::EnumParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_SocketIOClient_ESIOConnectionCloseReason_Statics::Enum_MetaDataParams), Z_Construct_UEnum_SocketIOClient_ESIOConnectionCloseReason_Statics::Enum_MetaDataParams)
};
...
// End Enum ESIOConnectionCloseReason

// Begin Enum ESIOThreadOverrideOption
...
static UEnum* ESIOThreadOverrideOption_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_ESIOThreadOverrideOption.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SocketIOClient_ESIOThreadOverrideOption, (UObject*)Z_Construct_UPackage__Script_SocketIOClient(), TEXT("ESIOThreadOverrideOption"));
	}
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SocketIOClient_ESIOThreadOverrideOption_Statics::EnumParams = {
	...
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::Regular,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_SocketIOClient_ESIOThreadOverrideOption_Statics::Enum_MetaDataParams), Z_Construct_UEnum_SocketIOClient_ESIOThreadOverrideOption_Statics::Enum_MetaDataParams)
};
...
// End Enum ESIOThreadOverrideOption

// Begin Registration
struct Z_CompiledInDeferFile_FID_Github_Stars_Beyond_Game_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESIOConnectionCloseReason_StaticEnum, TEXT("ESIOConnectionCloseReason"), &Z_Registration_Info_UEnum_ESIOConnectionCloseReason, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2670129350U) },
		{ ESIOThreadOverrideOption_StaticEnum, TEXT("ESIOThreadOverrideOption"), &Z_Registration_Info_UEnum_ESIOThreadOverrideOption, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2344883505U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Github_Stars_Beyond_Game_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h_3973194434(TEXT("/Script/SocketIOClient"),
	nullptr, 0,
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Github_Stars_Beyond_Game_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Github_Stars_Beyond_Game_Plugins_SocketIOClient_Source_SocketIOClient_Public_SocketIONative_h_Statics::EnumInfo));
// End Registration
